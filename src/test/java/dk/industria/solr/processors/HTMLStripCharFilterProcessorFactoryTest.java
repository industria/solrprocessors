...
public class HTMLStripCharFilterProcessorFactoryTest {
     ...
     */
    @Test
    public void initFactoryWithLegal() {
     ...
     */
    @Test
    public void initFactoryWithIllegalTypeFields() {
        NamedList<Object> input = new NamedList<Object>();
        input.add("field", "header");
        input.add("field", 100);
        input.add("field", "content");
     ...
     */
    @Test
    public void initFactoryWithAllIllegalTypeFields() {
        NamedList<Object> input = new NamedList<Object>();
        input.add("field", 1L);
        input.add("field", 100);
