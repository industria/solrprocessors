...
public class HTMLStripCharFilterProcessorTest {
    ...
    /**
     * Checks the getIntance creates an UpdateRequestProcessor.
     */  
    @Test public void instanceReturn() {
     ...
     */  
    @Test public void markupNoneHeaderInContent() {
        UpdateRequestProcessor processor = headerContentProcessor();
     ...
     */  
    @Test public void markupNoneHeaderInContentMultivalued() {
        UpdateRequestProcessor processor = headerContentProcessor();
     ...
     */  
    @Test public void markupNoneHeaderInContentMultivaluedNoBreak() {
        UpdateRequestProcessor processor = headerContentProcessor();
